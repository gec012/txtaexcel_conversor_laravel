...
<div class="card-body">
<table id="myTable" class="table table-hover table-active table-bordered ">
    <tr>
    ...
    @foreach ($archivos as $arch)
        <tr class="text-white">
            ...
            <td><a href="{{$arch->url}}" target='_blank'>Ver Archivo Txt</a></td>
            ...
            <td> {!! Form::open(['method' => 'DELETE','route' => ['unsa.destroy',$arch->id],'style'=>'display:inline']) !!}
